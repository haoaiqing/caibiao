...
@interface RewardTaskListVC ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, assign) int taskMode;//任务模块 1-悬赏任务 2-大师任务
...
@implementation RewardTaskListVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.taskModel = self.dataArray[indexPath.row];
...
- (void)requestData {
    ...
    [params setValue:@(self.taskMode) forKey:@"taskMode"];//任务模块 1-悬赏任务 2-大师任务
