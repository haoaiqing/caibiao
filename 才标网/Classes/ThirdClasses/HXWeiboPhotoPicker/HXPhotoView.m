...
{
    return [[self alloc] initWithManager:manager andImageArray:nil];
}

- (instancetype)initWithFrame:(CGRect)frame WithManager:(HXPhotoManager *)manager andImageArray:(NSArray *)imageArray
{
    self = [super initWithFrame:frame];
    if (self) {
        self.manager = manager;
        [self setupWithArray:imageArray];
    }
    return self;
}

- (instancetype)initWithManager:(HXPhotoManager *)manager andImageArray:(NSArray *)imageArray
{
    self = [super init];
    if (self) {
        self.manager = manager;
...
- (void)setupWithArray:(NSArray *)imageArray
{
